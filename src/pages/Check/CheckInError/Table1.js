    ...
    render = () => {
        const expandedRowRender = (record,index) => {
            ...
            const columns = [
                ...
                {title:"物料编码",dataIndex:"materialCode",key:"outCode"},
                {title:"物料名称",dataIndex:"materialInstance.material.name",key:"name"},
                {title:"规格型号",dataIndex:"materialInstance.material.standard",key:"standard"},
                {title:"质量要求",dataIndex:"materialInstance.material.qr",key:"qr"},
                {title:"保质期",dataIndex:"materialInstance.material.expirationDate",key:"expirationDate"},
                {title:"物料序列编码",dataIndex:"materialOrder",key:"materialOrder"},
                {title:"生产日期",dataIndex:"materialInstance.producedTime",key:"producedTime"},
                {title:"生产批号",dataIndex:"materialInstance.batchNumber",key:"batchNumber"},
                {title:"储存位置",dataIndex:"materialInstance.whLocationCode",key:"whLocationCode"},
