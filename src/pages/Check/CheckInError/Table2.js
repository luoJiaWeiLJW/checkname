...
class Table2 extends Component{
    ...
    axios=()=>{
        ...
        axios({
            url:"/exception/type/in/code/"+this.props.code+"/goods",
            method:'get',
            params: {
                pageindex,
                pagesize,
    ...
    render = () => {
            return <Table size="middle" loading={this.state.loading} pagination={this.state.pagination} columns={this.props.columns} onChange={this.handleTableChange} dataSource ={this.state.dataSource} rowKey={record=>record.id} />
    }
